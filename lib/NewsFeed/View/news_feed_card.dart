        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: ClipRRect(
              ...
              // FIX 2: Replace FadeInImage.assetNetwork with Image.network
              // FadeInImage loads BOTH the placeholder AND the network image
              // simultaneously into memory — doubling your RAM usage per cell.
              // Image.network with cacheWidth is much safer in a GridView.
              child: Image.network(
                url,
                fit: BoxFit.cover,

                // FIX 3: cacheWidth limits decoded image size in memory.
                // Without this each thumbnail is decoded at full resolution
                // (e.g. a 3000px wide photo = ~34MB per cell × 9 visible = crash).
                // 300px is plenty for a 3-column grid thumbnail.
                cacheWidth: 300,

                // FIX 4: errorBuilder prevents an unhandled exception from
                // a single bad URL crashing the entire screen.
                errorBuilder: (context, error, stackTrace) {
                  return Container(
                    color: Colors.grey[200],
                    child: const Icon(
                ...
                // FIX 5: loadingBuilder shows a placeholder while loading
                // instead of a blank cell, improving perceived performance.
